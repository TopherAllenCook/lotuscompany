    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{ fontFamily: font, minWidth: 0 }}
        >
          {/* Header row */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", background: "rgba(77,186,214,0.12)", minWidth: 0 }}>
            {[
              ...
              <div key={h.id} style={{ padding: "10px 16px", minWidth: 0, overflow: "hidden" }}>
