      ...
      <div style={{ position: "relative", display: "flex", alignItems: "center", height: "100%", padding: "56px 64px 72px", gap: 32 }}>
        ...
        >
              ...
              <motion.div key={i} custom={i} initial="hidden" animate="visible" variants={bulletVariants}>
                <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  ...
                  <EditableText
                    ...
                    as="p"
                    style={{ fontSize: "14px", color: "rgba(255,255,255,0.88)", fontWeight: 400, letterSpacing: "0.04em", fontFamily: font, lineHeight: 1.65, margin: 0, textTransform: "lowercase" }}
                  >
                    {bullet}
                  </EditableText>
                </div>
          ...
          <EditableText
            ...
            as="p"
            style={{ fontSize: "10px", color: "rgba(255,255,255,0.35)", fontWeight: 300, letterSpacing: "0.06em", fontFamily: font, margin: "24px 0 0", textTransform: "lowercase" }}
          >
            ...
            >
              ...
              >
                ...
                <div style={{ flex: "0 0 140px" }}>
                  <div style={{ fontSize: "15px", color: "#fff", fontFamily: font, fontWeight: 400, textTransform: "lowercase", lineHeight: 1.3 }}>
                    {p.name}
                  </div>
                  <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.5)", fontFamily: font, fontWeight: 300, textTransform: "lowercase", marginTop: "3px", letterSpacing: "0.04em" }}>
                    {p.role}
                  </div>
                </div>
                ...
                {/* Stat */}
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: "clamp(26px, 2.8vw, 40px)", color: theme.turquoise, fontFamily: font, fontWeight: 300, lineHeight: 1, letterSpacing: "-0.02em" }}>
                    {p.stat}
                  </div>
                  <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.6)", fontFamily: font, fontWeight: 300, textTransform: "lowercase", marginTop: "6px", lineHeight: 1.4 }}>
                    {p.descriptor}
                  </div>
                </div>
              </div>
