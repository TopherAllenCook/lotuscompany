              ...
              {projectInfo.map((row, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderBottom: i < projectInfo.length - 1 ? "1px solid rgba(77,186,214,0.08)" : undefined,
                  }}
                >
                  <EditableText
              ...
              {terms.map((row, i) => (
                <div
                  ...
                  style={{
                    ...
                    gridTemplateColumns: "1.2fr 1fr",
                    background: i % 2 === 0 ? "transparent" : "rgba(77,186,214,0.03)",
                    borderBottom: i < terms.length - 1 ? "1px solid rgba(77,186,214,0.08)" : undefined,
                  }}
                >
                  <EditableText
